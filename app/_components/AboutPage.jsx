...
function AboutPage() {
  ...
  return (
    <>
    <Helmet>
      <title>About Skudunter</title>
      <link rel='icon' href='/images/pfp.ico'></link>
    </Helmet>
      <article>
        <canvas
          id="aboutCanvas"
        ...
        <div className="mx-auto mt-8 w-8/12 h-auto bg-tersiary bg-opacity-70 rounded-2xl text-center text-slate-50 py-4 ">
          ...
          <p className="text-2xl font-thin w-11/12 mx-auto">
            I'm a software developer from the beautiful city of Cape Town. With
            a passion for crafting elegant and efficient code, I'm proficient in
            a range of programming languages and technologies. Whether it's
            building sleek user interfaces with React.js and p5.js, crafting
            robust backends with Node.js and SQL, or developing engaging games
            with C#, .Net, and Unity, I'm always up for a challenge. And when it
            comes to styling, I've got you covered with my knowledge of CSS,
            Tailwind, and HTML. From Delphi to Pascal, I've got the skills to
